...
parser.add_argument('--save', type=str, default='results/finetune/', help='location of the LOL_v1 corpus')
parser.add_argument('--model', type=str, default='./weights/difficult.pt', help='location of the LOL_v1 corpus')
