...
parser.add_argument('--save', type=str, default='EXP/', help='location of the LOL_v1 corpus')
#################################################################################################
parser.add_argument('--lowlight_images_path', type=str, default="LOL_v1/Train/low/",help='训练低光图像路径')
parser.add_argument('--highlight_images_path', type=str, default="LOL_v1/Train/high/",help='训练正常图像路径')
parser.add_argument('--val_lowlight_images_path', type=str, default="LOL_v1/Test/low/",help='验证低光图像路径')
parser.add_argument('--val_highlight_images_path', type=str, default="LOL_v1/Test/high/",help='验证低光图像路劲')
...
parser.add_argument('--n_threads', type=int, default=0,help='number of threads for LOL_v1 loading')
parser.add_argument('--cpu', action='store_true',help='use cpu only')
# parser.add_argument('--n_GPUs', type=int, default=4,
#                     help='number of GPUs')
parser.add_argument('--n_GPUs', type=int, default=1,help='number of GPUs')
# Data specifications
parser.add_argument('--dir_data', type=str, default='../LOL_v1',help='dataset directory')
...
parser.add_argument('--data_range', type=str, default='1-200/1-100',help='train/Test LOL_v1 range')
...
parser.add_argument('--no_augment', action='store_true',help='do not use LOL_v1 augmentation')
'''
# Model specifications
 parser.add_argument('--model', default='spdnet',
                     help='model name')
'''
parser.add_argument('--model', default='spdnet',help='model name')
